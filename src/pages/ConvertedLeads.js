        ...
        <div className="container mx-auto px-0 max-w-7xl">
          <div className="flex justify-between items-center mb-6">
            <div className="flex items-center gap-2">
              <label htmlFor="sortLeads" className="text-xs font-medium text-gray-600">
                Sort Leads by Age:
              </label>
              <select
                id="sortLeads"
                      ...
                      <div className="flex-1 pr-12">
                        ...
                        <div className="flex items-center gap-2 mt-2">
                          <span className="converted-badge">
                            Converted {conversionTime} day{conversionTime !== 1 ? "s" : ""} ago
                          </span>
                          <span
        ...
        >
          ...
          >
            <div className="bg-[var(--primary-blue)] text-white p-4 rounded-t-lg flex justify-between items-center">
              <h5 className="text-base font-medium">Converted Lead Details</h5>
              <button
                type="button"
            ...
            <div className="p-4 flex-1 overflow-y-auto">
              {window.innerWidth <= 640 ? (
                ...
                <div className="mobile-concise-view">
                  <div className="bg-white p-4 rounded-lg shadow-sm mb-4 border border-secondary-grey">
                    ...
                    <div className="grid grid-cols-2 gap-3">
                      <div>
                        ...
                        <p className="detail-value">{selectedLead.customer_name}</p>
                      </div>
                      <div>
                      ...
                      <div>
                        ...
                        <p className="detail-value">{selectedLead.location || "N/A"}</p>
                      </div>
                      <div>
                  ...
                  <div className="bg-white p-4 rounded-lg shadow-sm mb-4 border border-secondary-grey">
                    <h6 className="text-base font-medium text-primary-blue mb-3">
                      <i className="bi bi-currency-dollar mr-2"></i> Payment Details
                    </h6>
                    <div className="grid grid-cols-2 gap-3">
                      <div>
                  ...
                  <div className="bg-white p-4 rounded-lg shadow-sm mb-4 border border-secondary-grey">
                    ...
                    <div className="space-y-3">
                      {selectedLead.lead_details
                        ?.filter(
                          (vehicle) =>
                            vehicle.invoice_no && vehicle.invoice_no.trim() !== ""
                        )
                        .map((vehicle) => {
                ...
                <div className="space-y-6">
                  <div className="bg-white p-5 rounded-lg shadow-sm border">
                    <h6 className="text-lg font-semibold text-primary-blue mb-4">
                      <i className="bi bi-person-fill mr-2"></i> Customer Details
                    </h6>
                    <div className="grid grid-cols-2 gap-6">
                      ...
                      <div>
                        <strong>Location:</strong> {selectedLead.location || "N/A"}
                      </div>
                      <div>
                    ...
                    <div className="space-y-4">
                      {selectedLead.lead_details
                        ...
                        .map((vehicle) => {
                          ...
                          return (
                            <div key={vehicle.id} className="flex gap-4 border border-gray-200 rounded-lg p-4">
                              <div className="w-1/4">
                                <img
                                  src={vehicleImage}
                                  alt={`${vehicle.brand_name} ${vehicle.variant_name}`}
                              ...
                              <div className="w-3/4">
                                ...
                                <div className="grid grid-cols-2 gap-4">
                                  <div>
                                    <strong>Color:</strong> {vehicle.color_name || "N/A"}
                                  </div>
                                  <div>
                                  ...
                                  <div>
                                    ...
                                    {vehiclePrice > 0
                                      ? `$${parseFloat(vehiclePrice).toLocaleString("en-IN")}`
                                      : "Price on request"}
                                  </div>
                                  <div>
                                  ...
                                  {vehicle.invoice_no && (
                                    <div>
                                      <strong>Invoice No:</strong> {vehicle.invoice_no}
                                    </div>
                                  )}
                                </div>
                              </div>
