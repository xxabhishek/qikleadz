        ...
        <section className="p-3 sm:p-4 md:p-6">
          <div className="bg-white rounded-xl shadow-sm overflow-hidden">
            ...
            <div className="page-header flex justify-between items-center p-4">
              ...
              <button
                onClick={toggleFilter}
                className="rounded-md px-4 py-2 text-sm flex items-center border border-gray-300 hover:bg-gray-50"
              >
            ...
            <div className="p-4 sm:p-5">
              {/* Desktop Filters - Hidden as per target design */}
              ...
              {/* Mobile Filter Overlay - Updated to match target design */}
              {isFilterOpen && (
              ...
              {/* Brand-wise Model Grid - Updated to match target design */}
              <div id="brandModelGrid" className="space-y-6">
                {groupByBrand().map((brand) => (
                  <div key={brand.id} className="brand-section">
                    {/* Brand Header */}
                        ...
                        return (
                          ...
                          >
                            ...
                            <div className="model-card-content">
                              ...
                              {/* Price Display - Updated to match target design */}
                              <div className="">
              ...
              {/* Sticky Next Button - Updated to match target design */}
              {filteredVariants.length > 0 && (
                <div className="sticky-next-button">
                  <button
                    ...
                    disabled={!selectedVariant}
                    className={`w-full rounded-lg px-6 py-3 text-base font-medium transition-all flex items-center justify-center ${
                      selectedVariant
                        ? "bg-primary-blue text-white hover:bg-hover-blue shadow-lg hover:shadow-xl"
                        : "bg-gray-300 text-gray-500 cursor-not-allowed"
                    }`}
                  >
                    Next
