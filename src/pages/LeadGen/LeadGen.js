...
//                       {/* Variant - Cascading based on Segment + Brand */}
//                       <div>
//                         <label className="block text-sm font-medium text-gray-700 mb-1">
//                           Variant
//                         </label>
...
//                           {getFilteredVariantsForDropdown().length === 0 ? (
//                             <option disabled>No variants available</option>
//                           ) : (
//                             getFilteredVariantsForDropdown().map((v) => (
...
//                       {/* Fuel Type - Dynamic based on current filtered variants */}
//                       <div>
//                         <label className="block text-sm font-medium text-gray-700 mb-1">
//                           Fuel Type
//                         </label>
...
//                             <option disabled>No fuel types available</option>
//                           ) : (
//                             getAvailableFuelTypes().map((f) => (
