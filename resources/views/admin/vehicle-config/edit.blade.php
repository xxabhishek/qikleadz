                    ...
                    <div class="card-body">
                        ...
                        <form method="POST" action="{{ route('vehicle-config.update', $vehicleConfigs->id) }}">
                            ...
                            <div class="form-group mb-3">
                                ...
                                <select name="model_id" id="model_id" class="form-control" required>
                                    ...
                                    @foreach($models as $model)
                                        <option value="{{ $model->id }}" {{ $vehicleConfigs->model_id == $model->id ? 'selected' : '' }}>
                                            {{ $model->name }}
                                        </option>
                                    @endforeach
                                </select>
                            ...
                            <div class="form-group mb-3">
                                ...
                                <select name="variant_id" id="variant_id" class="form-control" required>
                                    ...
                                    @foreach($variants as $variant)
                                        <option value="{{ $variant->id }}" {{ $vehicleConfigs->variant_id == $variant->id ? 'selected' : '' }}>
                                            {{ $variant->name }}
                                        </option>
                                    @endforeach
                                </select>
                            ...
                            <div class="form-group mb-3">
                                ...
                                <select name="fuel_type_id" id="fuel_type_id" class="form-control" required>
                                    ...
                                    @foreach($fuelTypes as $fuelType)
                                        <option value="{{ $fuelType->id }}" {{ $vehicleConfigs->fuel_type_id == $fuelType->id ? 'selected' : '' }}>
                                            {{ $fuelType->name }}
                                        </option>
                                    @endforeach
                                </select>
                            ...
                            <div class="form-group mb-3">
                                ...
                                <select name="country_id" id="country_id" class="form-control" required>
                                    ...
                                    @foreach($countries as $country)
                                        <option value="{{ $country->id }}" {{ $vehicleConfigs->country_id == $country->id ? 'selected' : '' }}>
                                            {{ $country->name }}
                                        </option>
                                    @endforeach
                                </select>
                            ...
                            <div class="form-group">
                                ...
                                <input type="text" name="price" id="price" value="{{ $vehicleConfigs->price }}"
