...
<style>
    ...
    .note-editor.note-frame {
        ...
        border-radius: 0.25rem !important; /* Match Bootstrap form-control */
        box-shadow: none !important; /* Remove unwanted shadows */
    }
    .note-editor.note-frame .note-editing-area .note-editable {
        background: #fff !important;
        padding: 10px !important; /* Standard padding for readability */
        line-height: 1.6 !important; /* Normal line spacing */
        font-size: 1rem !important; /* Standard font size */
    }
    .note-editor.note-frame:focus {
        border-color: #007bff !important; /* Bootstrap focus color */
        box-shadow: 0 0 0 0.2rem rgba(0, 123, 255, 0.25) !important; /* Focus shadow */
    ...
    .note-editor .note-toolbar {
        ...
        background-color: #f8f9fa !important; /* Light background for toolbar */
        padding: 3px 8px !important; /* Reduced padding for compactness */
    }
    .note-editor .note-btn {
        font-size: 0.85rem !important; /* Smaller button text size */
        padding: 3px 6px !important; /* Reduced padding for smaller buttons */
        height: 24px !important; /* Fixed height for consistency */
        line-height: 1 !important; /* Adjust line height for icons */
    }
    .note-editor .note-btn i.note-icon {
        font-size: 12px !important; /* Normal icon size (adjusted from 4px) */
        width: 12px !important; /* Match icon width */
        height: 12px !important; /* Match icon height */
        line-height: 12px !important; /* Center icon vertically */
    }

    /* Ensure dropdowns and menus are also compact */
    .note-editor .dropdown-menu {
        font-size: 0.85rem !important; /* Smaller dropdown text */
