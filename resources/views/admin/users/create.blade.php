                            ...
                            <div class="form-group">
                                ...
                                <select name="parent_id" id="parent_id" class="form-control">
                                    ...
                                    @foreach($distributors as $id => $name)
                                        <option value="{{ $id }}" class="parent-option distributor" style="display:none;">{{ $name }}</option>
                                    @endforeach

                                    {{-- Dealers (for Sales Executive role) --}}
                                    @foreach($dealers as $id => $name)
                                        <option value="{{ $id }}" class="parent-option dealer" style="display:none;">{{ $name }}</option>
                                    @endforeach
                                </select>
                            </div>
                        </div>
