            ...
            <div class="col-md-10">
                <div class="card">
                    <div class="card-header d-flex justify-content-between align-items-center">
                        ...
                        <a href="{{ route('tech-spec.create') }}" class="btn btn-primary btn-sm">+ Add Tech
                            Specification</a>
                    </div>
                    <div class="card-body">
                        @if (session('success'))
                                    ...
                                    @if($first) {{-- Make sure first exists --}}
                                        <tr>
                                            ...
                                            <td>
                                                ...
                                                <a href="{{ route('tech-spec.edit', $first->id) }}"
                                                    class="btn btn-sm btn-warning">Edit</a>
                                                <a href="{{ route('tech-spec.show', $first->id) }}"
                                                    class="btn btn-sm btn-info">Show</a>

                                                <form action="{{ route('tech-spec.destroy', $first->id) }}" method="POST"
                                                    class="d-inline">
                                                    @csrf
                                                    @method('DELETE')
                                                    <button type="submit"
                                                        onclick="return confirm('Are you sure you want to delete this TechSpec?')"
