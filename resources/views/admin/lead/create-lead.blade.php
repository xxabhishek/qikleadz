                        ...
                        <form id="leadForm" action="{{ route('lead.store') }}" method="POST" enctype="multipart/form-data">
                            ...
                            <div class="row mb-3">
                                <div class="col-md-6 mb-3">
                                    ...
                                    <input type="hidden" name="vehicle_segment_id"
                                        value="{{ $data['vehicle_segment_id'] ?? '' }}">
                                ...
                                <div class="col-md-6 mb-3">
                                    <label for="phoneNumber" class="form-label">Phone Number <span
                                            class="text-danger">*</span></label>
                                    <input type="tel" class="form-control" name="phone_no" id="phoneNumber"
                            ...
                            <div class="row mb-3">
                                <div class="col-md-6 mb-3">
                                    <label for="customerLocation" class="form-label">Location <span
                                            class="text-danger">*</span></label>
                                ...
                                <div class="col-md-6 mb-3">
                                    ...
                                    <input type="date" class="form-control" name="tentative_purchase_date"
                                        id="purchaseDate">
                                </div>
                            </div>
                            ...
                            <div class="row mb-3">
                                <div class="col-md-6 mb-3">
                                    ...
                                    <input type="number" class="form-control" name="vehicle_qty" id="quantity" min="1"
                                        value="1">
                                </div>
                                <div class="col-md-6 mb-3">
                                    ...
                                    <div class="form-check">
                                        <input class="form-check-input" type="radio" name="payment_mode" id="finance"
                                            value="finance">
                            ...
                            <div class="row mb-3">
                                ...
                                <div class="col-md-6 mb-3">
                                    ...
                                    <textarea class="form-control" name="additional_note" id="additionalNotes" rows="3"
                            ...
                            <div class="d-flex justify-content-between mt-4">
                                ...
                                <button type="button" class="btn btn-info text-white" id="addAnother">Add Another
                                    Vehicle</button>
