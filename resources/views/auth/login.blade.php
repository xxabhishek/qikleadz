                ...
                <div class="row g-0">
                    ...
                    <div class="col-12 col-xl-7 col-xxl-8 auth-cover-left align-items-center justify-content-center d-none d-xl-flex">
                        <div class="card shadow-none bg-transparent shadow-none rounded-0 mb-0">
                            <div class="card-body">
                                <img src="{{ asset('assets/images/login-images/login-cover.svg') }}" class="img-fluid auth-img-cover-login" width="650" alt="Login Cover Image" />
                            </div>
                        </div>
                    </div>
                                    ...
                                    <form method="POST" action="{{ route('login') }}" class="row g-3" novalidate>
                                        ...
                                        <div class="col-12">
                                            ...
                                            <input id="login_input"
                                                ...
                                                maxlength="255"
                                                aria-describedby="login_input-error">
                                            @error('login_input')
                                        ...
                                        <div class="col-12">
                                            ...
                                            <div class="input-group" id="show_hide_pin">
                                                ...
                                                <a href="javascript:;" class="input-group-text bg-transparent" aria-label="Toggle PIN visibility">
