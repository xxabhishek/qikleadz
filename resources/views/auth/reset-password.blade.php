...
<head>
    ...
    <title>Reset Password - QikLeadz</title>
...
<body>
    <div class="login-card">
        ...
        <div class="login-body">
            <h5 class="text-center mb-4">Reset Your PIN</h5>
            <p class="text-muted text-center mb-4">Enter your new 4-digit PIN.</p>
            ...
            <form method="POST" action="{{ route('password.update') }}">
                ...
                <div class="mb-3">
                    ...
                    <input type="password" class="form-control @error('pin') is-invalid @enderror"
                           id="pin" name="pin" maxlength="4" pattern="[0-9]{4}" required>
                    <div class="form-text">Enter a 4-digit numeric PIN</div>
                    @error('pin')
                        <div class="invalid-feedback">{{ $message }}</div>
                    @enderror
                </div>
                ...
                <div class="mb-3">
                    ...
                    <input type="password" class="form-control"
                           id="pin_confirmation" name="pin_confirmation" maxlength="4" pattern="[0-9]{4}" required>
                </div>
