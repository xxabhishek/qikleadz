    ...
    <div class="wrapper">
        ...
        <div class="page-wrapper">
            <div class="page-content container-animate">
                ...
                <!-- Pending Claim(s) Verification Section -->
                <section class="p-3">
                    <div class="card">
                        <div class="card-body">
                            <div class="d-flex justify-content-between align-items-center mb-3">
                                    ...
                                    <thead>
                                        <tr>
                                            <th class="bg-primary text-white cursor-pointer" onclick="sortTable(0)">
                                                <div class="d-flex align-items-center"><i class="bi bi-person-fill me-1"></i> Executive</div>
                                            </th>
                                            <th class="bg-primary text-white cursor-pointer" onclick="sortTable(1, true)">
                                                <div class="d-flex align-items-center"><i class="bi bi-list-check me-1"></i> Total Leads</div>
                                            </th>
                                            ...
                                            <th class="bg-primary text-white">
                                                <div class="d-flex align-items-center"><i class="bi bi-currency-dollar me-1"></i> Pay</div>
                                            </th>
                                        </tr>
                                    </thead>
                                    <tbody>
        ...
        @foreach($pendingVerificationLeads as $lead)
            ...
            <!-- Per-Vehicle Verification Modal -->
                            ...
                            <form id="verifyForm{{ $detail->id }}"
                                ...
                                <div class="modal-body">
                                    <div class="alert alert-light mb-4">
                                        ...
                                        <strong>Total Qty:</strong> {{ $detail->vehicle_qty }}<br>
                                    ...
                                    <div class="mb-4">
                                        ...
                                        <select name="verification_status"
                                            ...
                                            <option value="disputed">Disputed (Issue in Invoice)</option>
